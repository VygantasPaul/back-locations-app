...
import { GET_LOCATIONS, ADD_LOCATION, DELETE_LOCATION, GET_LOCATION_BY_ID, PUT_LOCATION, GET_LOCATION_RANDOM } from '../controllers/locations.js'
const router = express.Router();
import auth from "../middlewares/auth.js";
router.get('/locations/random', GET_LOCATION_RANDOM)
...
router.post('/locations/:id', auth, PUT_LOCATION)
